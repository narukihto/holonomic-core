    ...
    for _ in 0..50 {
        ...
        for i in 0..n - 1 {
            ...
            for _ in 0..100 {
                ...
                let next_j = (j + 1) % n;
                if (tension.data[current_path[i]][current_path[next_i]] + tension.data[current_path[j]][current_path[next_j]])
                    > (tension.data[current_path[i]][current_path[j]] + tension.data[current_path[next_i]][current_path[next_j]])
                {
